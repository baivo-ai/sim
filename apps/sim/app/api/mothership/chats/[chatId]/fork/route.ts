...
export const POST = withRouteHandler(
  async (request: NextRequest, context: { params: Promise<{ chatId: string }> }) => {
    try {
      ...
      // Load parent chat metadata and verify ownership.
      ...
      // Find the fork point in the parent transcript (sourced from copilot_messages).
      ...
      // Insert the new chat and its forked transcript atomically.
